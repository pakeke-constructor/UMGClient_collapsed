...
------------------------------------------------------------------------------
-- line segments
-- to_do: separate double-sided, one-sided, and pull-through (along normal) collisions?
...
function intersect.line_line_collide(a_start, a_end, a_rad, b_start, b_end, b_rad, into)
	...
	--to_do: pool storage
	--to_do proper calculus from http://geomalgorithms.com/a07-_distance.html
	local search_tab = {}
...
--to_do: ensure this is all of them
